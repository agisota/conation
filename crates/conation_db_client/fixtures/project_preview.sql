...
VALUES ('project-one', 'test_project_name', 'conation|user@user.com', '2019-10-16 00:00:00', '2019-10-16 00:00:00');
...
VALUES ('conation|user@user.com', 'project-one', 'project', 0, '2019-10-16 00:00:00', '2019-10-16 00:00:00');

-- Create project two with permissions
INSERT INTO public."Project" ("id","name", "userId", "createdAt", "updatedAt")
VALUES ('project-two', 'test_project_name', 'conation|other@user.com', '2019-10-16 00:00:00', '2019-10-16 00:00:00');
