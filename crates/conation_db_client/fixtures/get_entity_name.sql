...
('conation|user@user.com', 'user@user.com', 'User', 'cus_1234', '11111111-1111-1111-1111-111111111111');

INSERT INTO "Document" ("id", "name", "fileType", "owner", "createdAt", "updatedAt")
VALUES
    ('11111111-1111-1111-1111-111111111111', 'document', 'pdf', 'conation|user@user.com', '2019-10-16 00:00:00', '2019-10-16 00:00:00');

INSERT INTO "Chat" ("id", "name", "userId", "createdAt", "updatedAt")
VALUES
    ('11111111-1111-1111-1111-111111111111', 'chat', 'conation|user@user.com', '2019-10-16 01:01:00', '2019-10-16 01:01:00');

INSERT INTO comms_channels (id, name, channel_type, org_id, owner_id)
VALUES ('11111111-1111-1111-1111-111111111111', 'channel', 'public', NULL, 'conation|user@user.com');

INSERT INTO email_links (id, macro_id, fusionauth_user_id, email_address, provider, is_sync_active, created_at,
                         updated_at)
VALUES ('11111111-1111-1111-1111-111111111111', 'conation|user@user.com', '11111111-1111-1111-1111-111111111111',
