...
INSERT INTO public."Document" ("id","name","fileType", "owner")
(SELECT 'document-empty', 'test_document_name_empty','pdf', 'conation|user@user.com');

INSERT INTO public."DocumentText" ("id", "content", "documentId", "tokenCount")
(SELECT 2, '', 'document-empty', 0);

INSERT INTO public."Document" ("id","name","fileType", "owner")
(SELECT 'document-insufficient', 'test_document_name_insufficient','pdf', 'conation|user@user.com');

INSERT INTO public."DocumentText" ("id", "content", "documentId", "tokenCount")
(SELECT 3, 'Insufficient Content', 'document-insufficient', 0);

INSERT INTO public."Document" ("id","name","fileType", "owner")
(SELECT 'document-complete', 'test_document_name_complete','pdf', 'conation|user@user.com');
...
INSERT INTO public."Document" ("id","name","fileType", "owner")
(SELECT 'document-incomplete', 'test_document_name_incomplete','pdf', 'conation|user@user.com');
