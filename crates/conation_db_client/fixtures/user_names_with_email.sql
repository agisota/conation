...
VALUES
    ('conation|user_profile_1@macro.com', 'user_profile_1@macro.com', '11111111-1111-1111-1111-111111111111', NULL, false, false, false),
    ('conation|user_profile_2@macro.com', 'user_profile_2@macro.com', '22222222-2222-2222-2222-222222222222', NULL, false, false, false),
    ('conation|user_profile_3@macro.com', 'user_profile_3@macro.com', '33333333-3333-3333-3333-333333333333', NULL, false, false, false),
    ('conation|user_profile_4@macro.com', 'user_profile_4@macro.com', '44444444-4444-4444-4444-444444444444', NULL, false, false, false),
    ('conation|user_profile_5@macro.com', 'user_profile_5@macro.com', '55555555-5555-5555-5555-555555555555', NULL, false, false, false),
    ('conation|contact@example.com', 'contact@example.com', '66666666-6666-6666-6666-666666666666', NULL, false, false, false);
...
VALUES
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'conation|user_profile_1@macro.com', 'fa_user_1', 'user1@example.com', 'GMAIL', true);

-- Create email contacts (including one for conation|user_profile_3@macro.com with name, and one not in User table)
