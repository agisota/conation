...
VALUES
  ('chat-persistent', 'persistent chat', 'conation|user@user.com', 'gpt-4o', '2024-01-01 00:00:00', '2024-01-01 00:00:00', NULL, true),
  ('chat-ephemeral', 'ephemeral chat', 'conation|user@user.com', 'gpt-4o', '2024-02-01 00:00:00', '2024-02-01 00:00:00', NULL, false),
  ('chat-deleted', 'deleted chat', 'conation|user@user.com', 'gpt-4o', '2024-03-01 00:00:00', '2024-03-01 00:00:00', '2024-03-04 05:06:07.890', true);
