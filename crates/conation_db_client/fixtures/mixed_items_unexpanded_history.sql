...
VALUES ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'Test Project', 'conation|user@user.com', '2023-01-17 12:00:00', '2023-01-17 12:00:00');
...
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "createdAt", "updatedAt", "documentFamilyId",
                               "projectId")
VALUES ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'Test Document', 'pdf', 'conation|user@user.com', '2023-01-15 10:00:00', '2023-01-15 10:00:00', 1,
...
VALUES ('cccccccc-1111-1111-1111-111111111111', 'conation|user@user.com', 'Test Chat', '2023-01-16 11:00:00', '2023-01-16 11:00:00', true,
        'ffffffff-ffff-ffff-ffff-ffffffffffff');
...
VALUES ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'document', 'conation|user@user.com', 'user', 'owner'),
       ('cccccccc-1111-1111-1111-111111111111', 'chat', 'conation|user@user.com', 'user', 'owner'),
       ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'project', 'conation|user@user.com', 'user', 'owner');
...
('conation|user@user.com', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'document', '2024-02-15 09:00:00', '2024-02-15 10:00:00'),
-- Make the project the second most recently viewed item
('conation|user@user.com', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'project', '2024-02-14 09:00:00', '2024-02-14 10:00:00');
