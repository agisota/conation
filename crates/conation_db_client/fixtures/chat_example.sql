...
VALUES ('d0000001-0000-0000-0000-000000000001', 'test_document_name','pdf', 'conation|user@user.com');
INSERT INTO public."Document" ("id","name","fileType", "owner")
VALUES ('d0000002-0000-0000-0000-000000000002', 'test_document_name','pdf', 'conation|user@user.com');
INSERT INTO public."Document" ("id","name","fileType", "owner")
VALUES ('d0000003-0000-0000-0000-000000000003', 'test_document_name','pdf', 'conation|user@user.com');

-- Test Chats
INSERT INTO public."Chat" ("id","name","userId", "model", "createdAt", "updatedAt")
VALUES ('chat-one', 'test-chat', 'conation|user@user.com', 'gpt-4o', '2019-10-16 00:00:00', '2019-10-16 00:00:00');
INSERT INTO public."Chat" ("id","name","userId", "model", "createdAt", "updatedAt")
VALUES ('chat-two', 'test-chat 2', 'conation|user@user.com', 'gpt-4o', '2019-10-16 00:00:01', '2019-10-16 00:00:01');
INSERT INTO public."Chat" ("id","name","userId", "model", "createdAt", "updatedAt")
VALUES ('chat-three', 'test-chat 3', 'conation|user@user.com', 'gpt-4o', '2019-10-16 00:00:01', '2019-10-16 00:00:01');
