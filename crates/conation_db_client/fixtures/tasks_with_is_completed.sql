...
VALUES ('11111111-1111-1111-1111-111111111111', 'Completed Task', 'txt', 'conation|user@user.com', '2024-01-01 10:00:00', '2024-01-02 11:00:00');
...
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "createdAt", "updatedAt")
VALUES ('22222222-2222-2222-2222-222222222222', 'Incomplete Task', 'txt', 'conation|user@user.com', '2024-01-01 11:00:00', '2024-01-02 12:00:00');
...
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "createdAt", "updatedAt")
VALUES ('33333333-3333-3333-3333-333333333333', 'Task No Status', 'txt', 'conation|user@user.com', '2024-01-01 12:00:00', '2024-01-02 13:00:00');
...
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "createdAt", "updatedAt")
VALUES ('44444444-4444-4444-4444-444444444444', 'Regular Document', 'pdf', 'conation|user@user.com', '2024-01-01 13:00:00', '2024-01-02 14:00:00');
...
VALUES ('11111111-1111-1111-1111-111111111111', 'document', 'conation|user@user.com', 'user', 'owner'),
       ('22222222-2222-2222-2222-222222222222', 'document', 'conation|user@user.com', 'user', 'owner'),
       ('33333333-3333-3333-3333-333333333333', 'document', 'conation|user@user.com', 'user', 'owner'),
