...
VALUES ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Doc A', 'txt', 'conation|user@user.com', '2024-01-01 10:00:00', '2024-01-02 11:00:00');

-- Document B: Newest created, oldest updated, middle viewed
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "createdAt", "updatedAt")
VALUES ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Doc B', 'pdf', 'conation|user@user.com', '2024-01-01 12:00:00', '2024-01-02 10:00:00');

-- Document C: Middle created, newest updated, oldest viewed
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "createdAt", "updatedAt")
VALUES ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Doc C', 'pdf', 'conation|user@user.com', '2024-01-01 11:00:00', '2024-01-02 12:00:00');
...
VALUES ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'document', 'conation|user@user.com', 'user', 'owner'),
       ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'document', 'conation|user@user.com', 'user', 'owner'),
       ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'document', 'conation|user@user.com', 'user', 'owner');
...
VALUES ('conation|user@user.com', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'document', '2024-01-03 12:00:00'), -- Newest viewed
       ('conation|user@user.com', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'document', '2024-01-03 11:00:00');
