...
(SELECT 'p1', 'a', 'conation|user@user.com', '2019-10-16 00:00:00');

-- Should have user history for user
INSERT INTO public."Project" ("id", "name", "userId", "parentId", "deletedAt")
(SELECT 'p2', 'b', 'conation|user@user.com', 'p1', '2019-10-16 00:00:00');

-- Should have user history for user2
INSERT INTO public."Project" ("id", "name", "userId", "parentId", "deletedAt")
(SELECT 'p3', 'c', 'conation|user2@user.com', 'p2', '2019-10-16 00:00:00');

-- Should have user history for user
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "deletedAt", "projectId")
(SELECT 'd1', 'd1', 'docx', 'conation|user@user.com', '2019-10-16 00:00:00', 'p1');

-- Should have user history for user2
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "deletedAt", "projectId")
(SELECT 'd2', 'd2', 'docx', 'conation|user2@user.com', '2019-10-16 00:00:00', 'p2');

-- Should not be reverted as it's not deleted
INSERT INTO public."Document" ("id", "name", "fileType", "owner", "projectId")
(SELECT 'd3', 'd3', 'docx', 'conation|user@user.com', 'p3');

-- Should have user history for user
INSERT INTO public."Chat" ("id", "name", "userId", "deletedAt", "projectId")
(SELECT 'c1', 'c1', 'conation|user@user.com', '2019-10-16 00:00:00', 'p1');

-- Should have user history for user2
INSERT INTO public."Chat" ("id", "name", "userId", "deletedAt", "projectId")
(SELECT 'c2', 'c2', 'conation|user2@user.com', '2019-10-16 00:00:00', 'p2');

-- Should not be reverted as it's not deleted
INSERT INTO public."Chat" ("id", "name", "userId", "projectId")
(SELECT 'c3', 'c3', 'conation|user@user.com', 'p3');
