...
INSERT INTO public."User" ("id","email","stripeCustomerId", "organizationId","macro_user_id")
(SELECT 'conation|user2@user.com', 'user2@user.com','stripe_id2', 1, 'a2222222-2222-2222-2222-222222222222');

INSERT INTO public."User" ("id","email","stripeCustomerId", "organizationId","macro_user_id")
(SELECT 'conation|user3@user.com', 'user3@user.com','stripe_id3', 1, 'a3333333-3333-3333-3333-333333333333');

INSERT INTO public."User" ("id","email","stripeCustomerId","macro_user_id")
(SELECT 'conation|user4@user.com', 'user4@user.com','stripe_id4', 'a4444444-4444-4444-4444-444444444444');

INSERT INTO public."User" ("id","email","stripeCustomerId","macro_user_id")
(SELECT 'conation|user5@user.com', 'user5@user.com','stripe_id5', 'a5555555-5555-5555-5555-555555555555');

INSERT INTO public."Document" ("id","name","fileType", "owner", "createdAt", "updatedAt")
(SELECT 'document-one', 'test_document_name','pdf', 'conation|user@user.com', '2019-10-16 00:00:00', '2019-10-16 00:00:00');
...
(SELECT 'conation|user@user.com', 'document-one', 'document', '2019-10-16 00:00:00', '2019-10-16 00:00:00');

INSERT INTO public."Document" ("id","name","fileType", "owner", "createdAt", "updatedAt")
(SELECT 'document-two', 'test_document_name','pdf', 'conation|user@user.com', '2019-10-16 00:00:00', '2019-10-16 00:00:00');
