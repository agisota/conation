...
(SELECT 'project-one', 'test_project_name','conation|user@user.com', NULL, '2019-10-16 00:00:00', '2019-10-16 00:00:00');
...
INSERT INTO public."Project" ("id","name","userId","parentId","createdAt","updatedAt")
(SELECT 'project-two', 'test_project_name','conation|user2@user.com', NULL, '2019-10-16 00:00:00', '2019-10-16 00:00:00');
