...
// this has types that should not become dependencies of conation_db_client
...
pub async fn create_chat_v2(
    ...
    // move this as a standalone query to conation_db_client/dcs/create_empty_chat
    ...
    entity_access_db_utils::insert_entity_access_row(
        &mut transaction,
        &conation_uuid::string_to_uuid(&chat.id).unwrap(),
        EntityType::Chat,
        user_id.as_ref(),
