...
pub fn validate_conation_access_token(
    conation_access_token: &str,
    args: &JwtValidationArgs,
) -> Result<MacroAccessToken, MacroAuthError> {
    validate_conation_access_token_inner(
        conation_access_token,
        &args.jwt_secret,
        &args.audience,
        &args.issuer,
    )
...
pub fn decode_conation_access_token_allow_expired(
    conation_access_token: &str,
    args: &JwtValidationArgs,
...
-----END PUBLIC KEY-----"#;
    ...
    #[test]
    fn test_handler_conation_access_token() -> anyhow::Result<()> {
    ...
    #[test]
    fn test_handler_conation_api_token() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
            audience: Audience::new_testing("test_audience"),
            issuer: Issuer::new_testing("test.macro.com"),
            jwt_secret: LocalOrRemoteSecret::Local(JwtSecretKey::new_testing("super_secret_key")),
    ...
    #[test]
    fn test_validate_conation_access_token_jwt_token() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
            audience: Audience::new_testing("test_audience"),
            issuer: Issuer::new_testing("test.macro.com"),
            jwt_secret: LocalOrRemoteSecret::Local(JwtSecretKey::new_testing("super_secret_key")),
        ...
        let result = validate_conation_access_token_inner(
            &token,
            &jwt_validation_args.jwt_secret,
            &jwt_validation_args.audience,
            &jwt_validation_args.issuer,
    ...
    #[test]
    fn test_validate_conation_access_token_jwt_token_invalid_audience() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
            audience: Audience::new_testing("test_audience"),
            issuer: Issuer::new_testing("test.macro.com"),
            jwt_secret: LocalOrRemoteSecret::Local(JwtSecretKey::new_testing("super_secret_key")),
    ...
    #[test]
    fn test_validate_conation_access_token_jwt_token_invalid_issuer() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
            audience: Audience::new_testing("test_audience"),
            issuer: Issuer::new_testing("test.macro.com"),
            jwt_secret: LocalOrRemoteSecret::Local(JwtSecretKey::new_testing("super_secret_key")),
    ...
    #[test]
    fn test_validate_conation_access_token_jwt_token_expired() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
            audience: Audience::new_testing("test_audience"),
            issuer: Issuer::new_testing("test.macro.com"),
            jwt_secret: LocalOrRemoteSecret::Local(JwtSecretKey::new_testing("super_secret_key")),
    ...
    #[test]
    fn test_validate_conation_api_token_jwt_token() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
        ...
        // Make jwt here using jsonwebtoken crate
        let result = validate_conation_api_token(
            &token,
            &jwt_validation_args.conation_api_token_public_key,
            &jwt_validation_args.conation_api_token_issuer,
        )?;
    ...
    #[test]
    fn test_validate_conation_api_token_jwt_token_invalid_issuer() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
            audience: Audience::new_testing(""),
            issuer: Issuer::new_testing(""),
            jwt_secret: LocalOrRemoteSecret::Local(JwtSecretKey::new_testing("")),
    ...
    #[test]
    fn test_validate_conation_api_token_jwt_token_expired() -> anyhow::Result<()> {
        let jwt_validation_args = JwtValidationArgs {
            audience: Audience::new_testing(""),
            issuer: Issuer::new_testing(""),
            jwt_secret: LocalOrRemoteSecret::Local(JwtSecretKey::new_testing("")),
