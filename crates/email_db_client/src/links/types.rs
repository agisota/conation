...
#[derive(Type, Debug, Clone, Copy, Doppleganger, PartialEq, Eq)]
...
impl DbUserProvider {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            DbUserProvider::Stalwart => "STALWART",
        }
    }
}
    ...
    fn from(service_link: models_email::email::service::link::Link) -> Self {
        Self {
            ...
            provider: match service_link.provider {
                ...
                models_email::service::link::UserProvider::Stalwart => DbUserProvider::Stalwart,
            },
    ...
    fn try_from(value: DbLink) -> Result<Self, Self::Error> {
        ...
        Ok(models_email::email::service::link::Link {
            ...
            provider: match provider {
                ...
                DbUserProvider::Stalwart => UserProvider::Stalwart,
            },
            is_sync_active,
            is_primary,
            needs_reauth,
