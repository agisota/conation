...
async fn contacts_ingress_enqueuer_maps_pairs() {
    ...
    let first = macro_user_id("conation|first@example.com");
    let second = macro_user_id("conation|second@example.com");
    let third = macro_user_id("conation|third@example.com");
