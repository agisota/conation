...
const BOT_FOR_CONATION_USER_ID_HEADER: &str = "x-conation-bot-for-conation-user-id";
const BOT_FOR_FUSIONAUTH_USER_ID_HEADER: &str = "x-conation-bot-for-fusionauth-user-id";
...
impl ScopedBotFixture {
    ...
    async fn permission(
        ...
        if include_acting_user {
            request = request
                .header(BOT_FOR_CONATION_USER_ID_HEADER, &self.acting_user_id)
