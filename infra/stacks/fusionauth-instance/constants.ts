...
// Local FusionAuth is generated by xtask's per-instance kickstart. Refuse the
// historical local Pulumi program before it can import a legacy application or
// read a secret from any provider.
if (stack === 'local') {
  throw new Error(
    'The local FusionAuth Pulumi program has been retired. Use `just stack up` from the repository root.'
  );
}
