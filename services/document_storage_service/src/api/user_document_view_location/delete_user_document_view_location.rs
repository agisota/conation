...
#[tracing::instrument(skip(ctx, user, _document), fields(user_id=?user.authorization.user.conation_user_id))]
pub async fn handler(
    ...
    match conation_db_client::user_document_view_location::delete::delete_user_document_view_location(
        &ctx.db,
