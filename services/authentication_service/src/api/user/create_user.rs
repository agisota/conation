...
pub async fn handler(
    ...
    let username_exists =
        conation_db_client::conation_user::check_username_exists(&ctx.db, &req.username)
            .await
            .map_err(|e| {
    ...
    let email_exists = conation_db_client::conation_user::check_email_exists(&ctx.db, &email)
        .await
        .map_err(|e| {
