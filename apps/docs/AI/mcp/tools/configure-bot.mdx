...
| `avatarUrl` | string | No | New profile-picture URL. Use a Conation static-file URL or another reachable image URL. Omit to keep the current picture; pass an empty string to clear it. |
