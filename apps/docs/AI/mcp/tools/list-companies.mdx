...
| `owner_user_id` | string | No | Filter to companies whose Owner property is this Conation user id (e.g. "conation\|user@example.com"). Use ListTeamMembers to find user ids. |
