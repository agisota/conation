...
| `avatarUrl` | string | No | Optional URL for the bot profile picture. Pass the URL of an image already uploaded to Conation static files or another reachable image URL. |
