...
export function EmailCompose(props: EmailComposeProps) {
  ...
  const ctxValue: ComposeContextValue = {
    ...
    // Compatibility field name in ComposeContext; this is feature access,
    // which Conation grants independently of subscription state.
    hasPaidAccess: hasFeatureAccess,
