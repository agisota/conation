    ...
    <>
      <div class="relative flex items-center">
        ...
        <input
          ...
          placeholder={t('settings.shell.search.placeholder')}
          aria-label={t('settings.shell.search.placeholder')}
          autocomplete="off"
          spellcheck={false}
          value={props.query}
        ...
        <Show when={props.query}>
          <Button
            ...
            label={t('settings.shell.search.clear')}
            aria-label={t('settings.shell.search.clear')}
            onClick={clear}
          >
      ...
      <Show when={searching()}>
        <Show
          ...
          fallback={
            <p class="px-2 py-1.5 text-xs text-ink-extra-muted">
              {t('settings.shell.search.noMatch', {
        ...
        >
          <div
            class="flex flex-col"
            role="listbox"
            aria-label={t('settings.shell.search.results')}
          >
