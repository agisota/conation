 ...
 *  `w-max` sizes to the label; `max-w-full` only clips if the composer is narrower. */
const PILL_TRIGGER_CLASS =
  'h-6 w-max max-w-full justify-start gap-1 overflow-hidden rounded-full border-transparent bg-ink/5 px-2 text-left text-xs text-ink-muted hover:bg-ink/10';
