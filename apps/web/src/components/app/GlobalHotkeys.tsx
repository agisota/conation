...
import { openConationMcpSetupModal } from '@app/features/integrations/mcp-setup/ConationMcpSetupModal';
...
export default function GlobalShortcuts() {
  ...
  registerHotkey({
    ...
    keyDownHandler: () => {
      openConationMcpSetupModal();
      return true;
    },
    icon: IconGear,
    runWithInputFocused: true,
    displayPriority: 9,
    tags: ['mcp', 'model context protocol', 'setup', 'connect conation'],
  });
