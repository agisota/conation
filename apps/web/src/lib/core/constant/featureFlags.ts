...
// AI agents: the Conation Coder mention entry and the folded agent-session view
...
// for each user's own Cursor key. Self-host defaults on; operators can disable
// with VITE_ENABLE_CURSOR_AGENTS=false. Override with
