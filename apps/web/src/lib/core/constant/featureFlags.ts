...
// Every authenticated user may connect their own Cursor key. Self-host
// defaults on; operators can explicitly disable it with
// VITE_ENABLE_CURSOR_AGENTS=false.
export const ENABLE_CURSOR_AGENTS_FLAG = 'enable-cursor-agents';
export const ENABLE_CURSOR_AGENTS_OVERRIDE =
  getFeatureFlagOverride('ENABLE_CURSOR_AGENTS') ?? true;
